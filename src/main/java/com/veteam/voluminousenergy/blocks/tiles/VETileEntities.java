...
public class VETileEntities {
    ...
    public static final VETileEntityFactory AIR_COMPRESSOR_FACTORY = new VETileEntityFactory(
            VEBlocks.AIR_COMPRESSOR.tile(), VEContainers.AIR_COMPRESSOR_FACTORY)
    ...
    public static final VETileEntityFactory AQUEOULIZER_TILE_FACTORY = new VETileEntityFactory(
            VEBlocks.AQUEOULIZER.tile(), VEContainers.AQUEOULIZER_FACTORY)
            .addEnergyStorageWithConsumption(
    ...
    public static final VETileEntityFactory BATTERY_BOX_FACTORY = new VETileEntityFactory(VEBlocks.BATTERY_BOX.tile(),
    ...
    public static final VETileEntityFactory BLAST_FURNACE_FACTORY = new VETileEntityFactory(
            VEBlocks.BLAST_FURNACE.tile(), VEContainers.BLAST_FURNACE_FACTORY)
            .addEnergyStorageWithConsumption(
    ...
    public static final VETileEntityFactory CENTRIFUGAL_AGITATOR_FACTORY = new VETileEntityFactory(
            VEBlocks.CENTRIFUGAL_AGITATOR.tile(), VEContainers.CENTRIFUGAL_AGITATOR_FACTORY)
            .addEnergyStorageWithConsumption(
    ...
    public static final VETileEntityFactory CENTRIFUGAL_SEPARATOR_FACTORY = new VETileEntityFactory(
            VEBlocks.CENTRIFUGAL_SEPARATOR.tile(), VEContainers.CENTRIFUGAL_SEPARATOR_FACTORY)
            .addEnergyStorageWithConsumption(
    ...
    public static final VETileEntityFactory COMBUSTION_GENERATOR_FACTORY = new VETileEntityFactory(
            VEBlocks.COMBUSTION_GENERATOR.tile(), VEContainers.COMBUSTION_GENERATOR_FACTORY)
            .addEnergyStorage(
    ...
    public static final VETileEntityFactory COMPRESSOR_FACTORY = new VETileEntityFactory(VEBlocks.COMPRESSOR.tile(),
    ...
    public static final VETileEntityFactory CRUSHER_FACTORY = new VETileEntityFactory(VEBlocks.CRUSHER.tile(),
    ...
    public static final VETileEntityFactory DIMENSIONAL_LASER_FACTORY = new VETileEntityFactory(
            VEBlocks.DIMENSIONAL_LASER.tile(), VEContainers.DIMENSIONAL_LASER_FACTORY)
            .addEnergyStorageWithConsumption(
    ...
    public static final VETileEntityFactory DISTILLATION_UNIT_FACTORY = new VETileEntityFactory(
            VEBlocks.DISTILLATION_UNIT.tile(), VEContainers.DISTILLATION_UNIT_FACTORY)
            .addEnergyStorageWithConsumption(
    ...
    public static final VETileEntityFactory ELECTRIC_FURNACE_FACTORY = new VETileEntityFactory(
            VEBlocks.ELECTRIC_FURNACE.tile(), VEContainers.ELECTRIC_FURNACE_FACTORY)
    ...
    public static final VETileEntityFactory FLUID_ELECTROLYZER_FACTORY = new VETileEntityFactory(
            VEBlocks.FLUID_ELECTROLYZER.tile(), VEContainers.FLUID_ELECTROLYZER_FACTORY)
            .addEnergyStorageWithConsumption(
            ...
            .addTanks(
                    ...
                    new FluidOutputTank(0, DEFAULT_TANK_CAPACITY),
                    new FluidOutputTank(1, DEFAULT_TANK_CAPACITY))
            .withRecipe(FLUID_ELECTROLYZING)
            .withCustomRecipeProcessing(new BasicProcessor());

    public static final VETileEntityFactory FLUID_MIXER_FACTORY = new VETileEntityFactory(VEBlocks.FLUID_MIXER.tile(),
    ...
    public static final VETileEntityFactory GAS_FIRED_FURNACE = new VETileEntityFactory(
            VEBlocks.GAS_FIRED_FURNACE.tile(), VEContainers.GAS_FIRED_FURNACE_FACTORY)
    ...
    public static final VETileEntityFactory HYDROPONIC_INCUBATOR_FACTORY = new VETileEntityFactory(
            VEBlocks.HYDROPONIC_INCUBATOR.tile(), VEContainers.HYDROPONIC_INCUBATOR_FACTORY)
            .addEnergyStorageWithConsumption(
    ...
    public static final VETileEntityFactory IMPLOSION_COMPRESSOR_FACTORY = new VETileEntityFactory(
            VEBlocks.IMPLOSION_COMPRESSOR.tile(), VEContainers.IMPLOSION_COMPRESSOR_FACTORY)
            .addEnergyStorageWithConsumption(
    ...
    public static final VETileEntityFactory PRIMITIVE_BLAST_FURNACE_FACTORY = new VETileEntityFactory(
            VEBlocks.PRIMITIVE_BLAST_FURNACE.tile(), VEContainers.PRIMITIVE_BLAST_FURNACE_FACTORY)
            .addEnergyStorage(0, 0)

            .withRecipe(PRIMITIVE_BLAST_FURNACING)
            .withCustomRecipeProcessing(new BasicProcessor());

    public static final VETileEntityFactory PRIMITIVE_SOLAR_PANEL_FACTORY = new VETileEntityFactory(
            VEBlocks.PRIMITIVE_SOLAR_PANEL.tile(), VEContainers.PRIMITIVE_SOLAR_PANEL_FACTORY)
            .addEnergyStorage(
    ...
    public static final VETileEntityFactory SOLAR_PANEL_FACTORY = new VETileEntityFactory(VEBlocks.SOLAR_PANEL.tile(),
    ...
    public static final VETileEntityFactory PRIMITIVE_STIRLING_GENERATOR_TILE_FACTORY = new VETileEntityFactory(
            VEBlocks.PRIMITIVE_STIRLING_GENERATOR.tile(), VEContainers.PRIMITIVE_STIRLING_GENERATOR_FACTORY)
            .addEnergyStorage(
    ...
    public static final VETileEntityFactory STIRLING_GENERATOR_FACTORY = new VETileEntityFactory(
            VEBlocks.STIRLING_GENERATOR.tile(), VEContainers.STIRLING_GENERATOR_FACTORY)
            .addEnergyStorage(
    ...
    public static final VETileEntityFactory TOOLING_STATION_FACTORY = new VETileEntityFactory(
            VEBlocks.TOOLING_STATION.tile(), VEContainers.TOOLING_STATION_FACTORY)
            ...
            .addTanks(new FluidInputOutputTank(0, Config.ALUMINUM_TANK_CAPACITY.get() * 1000,
                    (fluidStack, tile) -> CombustibleFluidsData.isCombustible(fluidStack)))
            .withCustomInventoryValidator(new ToolingStationInventoryValidator())
            .withCustomRecipeProcessing(new ToolingStationProcessor());

    // Tanks
    public static final VETileEntityFactory ALUMINUM_TANK_FACTORY = new VETileEntityFactory(
            VEBlocks.ALUMINUM_TANK.tile(), VEContainers.ALUMINUM_TANK_FACTORY)
            .withCustomInventoryValidator(new TankInventoryValidator())
            .addTanks(new FluidInputOutputTank(0, Config.ALUMINUM_TANK_CAPACITY.get() * 1000));

    public static final VETileEntityFactory EIGHZO_TANK_FACTORY = new VETileEntityFactory(VEBlocks.EIGHZO_TANK.tile(),
            VEContainers.EIGHZO_TANK_FACTORY)
            .withCustomInventoryValidator(new TankInventoryValidator())
            .addTanks(new FluidInputOutputTank(0, Config.EIGHZO_TANK_CAPACITY.get() * 1000));

    public static final VETileEntityFactory NETHERITE_TANK_FACTORY = new VETileEntityFactory(
            VEBlocks.NETHERITE_TANK.tile(), VEContainers.NETHERITE_TANK_FACTORY)
            .withCustomInventoryValidator(new TankInventoryValidator())
            .addTanks(new FluidInputOutputTank(0, Config.NETHERITE_TANK_CAPACITY.get() * 1000));

    public static final VETileEntityFactory NIGHALITE_TANK_FACTORY = new VETileEntityFactory(
            VEBlocks.NIGHALITE_TANK.tile(), VEContainers.NIGHALITE_TANK_FACTORY)
            .withCustomInventoryValidator(new TankInventoryValidator())
            .addTanks(new FluidInputOutputTank(0, Config.NIGHALITE_TANK_CAPACITY.get() * 1000));

    public static final VETileEntityFactory SOLARIUM_TANK_FACTORY = new VETileEntityFactory(
            VEBlocks.SOLARIUM_TANK.tile(), VEContainers.SOLARIUM_TANK_FACTORY)
            .withCustomInventoryValidator(new TankInventoryValidator())
            .addTanks(new FluidInputOutputTank(0, Config.SOLARIUM_TANK_CAPACITY.get() * 1000));

    public static final VETileEntityFactory TITANIUM_TANK_FACTORY = new VETileEntityFactory(
            VEBlocks.TITANIUM_TANK.tile(), VEContainers.TITANIUM_TANK_FACTORY)
            .withCustomInventoryValidator(new TankInventoryValidator())
