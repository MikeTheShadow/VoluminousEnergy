...
public class FluidMixerContainer extends VoluminousContainer {
    ...
    public FluidMixerContainer(int id, Level world, BlockPos pos, Inventory inventory, Player player){
        super(VEBlocks.FLUID_MIXER_CONTAINER,id);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(tileEntity.getLevel(),tileEntity.getBlockPos()),playerEntity, VEBlocks.FLUID_MIXER_BLOCK);
    }
