...
public class FluidElectrolyzerContainer extends VoluminousContainer {
    ...
    public FluidElectrolyzerContainer(int id, Level world, BlockPos pos, Inventory inventory, Player player){
        super(VEBlocks.FLUID_ELECTROLYZER_CONTAINER.get(),id);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(tileEntity.getLevel(),tileEntity.getBlockPos()),playerEntity, VEBlocks.FLUID_ELECTROLYZER_BLOCK.get());
    }
