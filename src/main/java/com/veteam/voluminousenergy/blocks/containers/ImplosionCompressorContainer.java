...
public class ImplosionCompressorContainer extends VoluminousContainer {
    ...
    public ImplosionCompressorContainer(int id, World world, BlockPos pos, PlayerInventory inventory, PlayerEntity player){
    ...
    public boolean stillValid(PlayerEntity playerIn) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(),tileEntity.getBlockPos()),playerEntity, VEBlocks.IMPLOSION_COMPRESSOR_BLOCK);
    }
