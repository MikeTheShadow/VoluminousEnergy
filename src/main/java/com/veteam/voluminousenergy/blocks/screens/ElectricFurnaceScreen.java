...
public class ElectricFurnaceScreen extends VEContainerScreen<VEContainer> {
    ...
    private final Identifier GUI = Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "textures/gui/electric_furnace_gui.png");
    ...
    protected void init() {
        ...
        List<VESlotManager> managers = tileEntity.getManagers();
    ...
    protected void extractTooltip(GuiGraphicsExtractor matrixStack, int mouseX, int mouseY) {
        if (isHovering(11, 16, 12, 49, mouseX, mouseY)) {
            matrixStack.setTooltipForNextFrame(this.font, TextUtil.powerBarTooltip(tileEntity.getEnergy(), Config.ELECTRIC_FURNACE_MAX_POWER.get()), mouseX, mouseY);
