...
public class AqueoulizerScreen extends ContainerScreen<AqueoulizerContainer> {
    ...
    protected void init(){
        ...
        // Output Tank
        this.addButton(new TankBoolButton(tileEntity.getOutputTank(), (this.width/2)-198, this.guiTop+100, button ->{
            // Do nothing
        }));

        this.addButton(new TankDirectionButton(tileEntity.getOutputTank(), (this.width/2)-184, this.guiTop+100, button ->{
            // Do nothing
        }));
    }
