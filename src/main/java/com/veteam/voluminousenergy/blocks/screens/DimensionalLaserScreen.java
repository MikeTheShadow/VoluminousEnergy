...
public class DimensionalLaserScreen extends VEContainerScreen<VEContainer> {
    ...
    protected void extractLabels(@NotNull GuiGraphicsExtractor matrixStack, int mouseX, int mouseY) {
        ...
        DimensionalLaserRecipeProcessor processor = (DimensionalLaserRecipeProcessor) tileEntity.getRecipeProcessor();
    ...
    public void extractBackground(GuiGraphicsExtractor matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (processor.isMultiBlockValid(tileEntity)) {
             ...
             */
            matrixStack.blit(RenderPipelines.GUI_TEXTURED, GUI, i + 97, j + 34, 176, 0, 15, progress, 256, 256);
