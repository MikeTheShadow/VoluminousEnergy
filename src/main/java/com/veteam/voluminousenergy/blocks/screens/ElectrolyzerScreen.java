...
public class ElectrolyzerScreen extends AbstractContainerScreen<ElectrolyzerContainer> {
    ...
    protected void renderLabels(PoseStack matrixStack,int mouseX, int mouseY) {
        ...
        this.font.drawShadow(matrixStack, TextUtil.translateVEBlock("electrolyzer"), 8.0F, 6.0F, 16777215);
    ...
    protected void renderTooltip(PoseStack matrixStack,int mouseX, int mouseY) {
        if (isHovering(11, 16, 12, 49, mouseX, mouseY)) {
            renderTooltip(matrixStack, Component.nullToEmpty(menu.getEnergy() + " FE" + " / " + Config.ELECTROLYZER_MAX_POWER.get() + " FE"), mouseX, mouseY);
        }
