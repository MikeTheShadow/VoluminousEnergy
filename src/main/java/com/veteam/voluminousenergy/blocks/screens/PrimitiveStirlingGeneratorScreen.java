...
public class PrimitiveStirlingGeneratorScreen extends VEContainerScreen<PrimitiveStirlingGeneratorContainer> {
    ...
    protected void renderLabels(GuiGraphics matrixStack,int mouseX, int mouseY){
        ...
        TextUtil.renderShadowedText(matrixStack,Minecraft.getInstance().font, Component.nullToEmpty(TextUtil.translateString("text.voluminousenergy.generating").getString() + ": " + generationRate + " FE/t"),  50, 18, WHITE_TEXT_STYLE);
