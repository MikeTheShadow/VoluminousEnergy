...
public class VEFluids {
    ...
    public static Supplier<LiquidBlock> FLOWING_OXYGEN_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "oxygen_block",
            Oxygen::FlowingOxygenBlock);
    public static Supplier<Item> OXYGEN_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "oxygen_bucket",
            Oxygen::OxygenBucket);
    ...
    public static Supplier<LiquidBlock> FLOWING_CRUDE_OIL_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "crude_oil_block",
            CrudeOil::FlowingCrudeOilBlock);
    public static Supplier<Item> CRUDE_OIL_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "crude_oil_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_NAPHTHA_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "naphtha_block",
            Naphtha::FlowingNaphthaBlock);
    public static Supplier<Item> NAPHTHA_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "naphtha_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_RFNA_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "red_fuming_nitric_acid_block",
            RedFumingNitricAcid::FlowingRedFumingNitricAcidBlock);
    public static Supplier<Item> RFNA_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "red_fuming_nitric_acid_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_WFNA_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "white_fuming_nitric_acid_block",
            WhiteFumingNitricAcid::FlowingWhiteFumingNitricAcidBlock);
    public static Supplier<Item> WFNA_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "white_fuming_nitric_acid_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_MERCURY_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "mercury_block",
            Mercury::FlowingMercuryBlock);
    public static Supplier<Item> MERCURY_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "mercury_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_SULFURIC_ACID_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "sulfuric_acid_block",
            SulfuricAcid::FlowingSulfuricAcidBlock);
    public static Supplier<Item> SULFURIC_ACID_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "sulfuric_acid_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_DINITROGEN_TETROXIDE_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "dinitrogen_tetroxide_block",
            DinitrogenTetroxide::FlowingDinitrogenTetroxideBlock);
    public static Supplier<Item> DINITROGEN_TETROXIDE_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "dinitrogen_tetroxide_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_COMPRESSED_AIR_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "compressed_air_block",
            CompressedAir::FlowingCompressedAirBlock);
    public static Supplier<Item> COMPRESSED_AIR_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "compressed_air_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_NITROGEN_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "nitrogen_block",
            Nitrogen::FlowingNitrogenBlock);
    public static Supplier<Item> NITROGEN_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "nitrogen_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_BIOFUEL_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "biofuel_block",
            Biofuel::FlowingBiofuelBlock);
    public static Supplier<Item> BIOFUEL_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "biofuel_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_DIESEL_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "diesel_block",
            Diesel::FlowingDieselBlock);
    public static Supplier<Item> DIESEL_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "diesel_bucket",
            Diesel::DieselBucket);
    ...
    public static Supplier<LiquidBlock> FLOWING_GASOLINE_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "gasoline_block",
            Gasoline::FlowingGasolineBlock);
    public static Supplier<Item> GASOLINE_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "gasoline_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_NITROGLYCERIN_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "nitroglycerin_block",
            Nitroglycerin::FlowingNitroglycerinBlock);
    public static Supplier<Item> NITROGLYCERIN_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "nitroglycerin_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_LIGHT_FUEL_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "light_fuel_block",
            LightFuel::FlowingLightFuelBlock);
    public static Supplier<Item> LIGHT_FUEL_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "light_fuel_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_LIQUEFIED_COAL_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "liquefied_coal_block",
            LiquefiedCoal::FlowingLiquefiedCoalBlock);
    public static Supplier<Item> LIQUEFIED_COAL_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "liquefied_coal_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_LIQUEFIED_COKE_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "liquefied_coke_block",
            LiquefiedCoke::FlowingLiquefiedCokeBlock);
    public static Supplier<Item> LIQUEFIED_COKE_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "liquefied_coke_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_TREE_SAP_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "tree_sap_block",
            TreeSap::FlowingTreeSapBlock);
    public static Supplier<Item> TREE_SAP_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "tree_sap_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_TREETHANOL_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "treethanol_block",
            Treethanol::FlowingTreethanolBlock);
    public static Supplier<Item> TREETHANOL_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "treethanol_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_AMMONIA_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "ammonia_block",
            Ammonia::FlowingAmmoniaBlock);
    public static Supplier<Item> AMMONIA_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "ammonia_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_AMMONIUM_NITRATE_SOLUTION_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "ammonium_nitrate_solution_block",
            AmmoniumNitrateSolution::FlowingAmmoniumNitrateSolutionBlock);
    public static Supplier<Item> AMMONIUM_NITRATE_SOLUTION_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "ammonium_nitrate_solution_bucket",
    ...
    public static Supplier<LiquidBlock> FLOWING_HYDROGEN_BLOCK_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerBlock(VE_FLUID_BLOCKS, "hydrogen_block",
            Hydrogen::FlowingHydrogenBlock);
    public static Supplier<Item> HYDROGEN_BUCKET_REG = com.veteam.voluminousenergy.util.VERegistryHelper.registerItem(VE_ITEM_REGISTRY, "hydrogen_bucket",
