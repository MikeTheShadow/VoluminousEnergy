...
public class Hydrogen {
    ...
    public static VEFlowingFluidBlock FlowingHydrogenBlock() {
        HYDROGEN_BLOCK = new VEFlowingFluidBlock(HYDROGEN, stdProp.setId(VERegistryHelper.currentBlockId()));
        return HYDROGEN_BLOCK;
    }

    public static Item HydrogenBucket() {
        HYDROGEN_BUCKET = new BucketItem(HYDROGEN, new Item.Properties().setId(VERegistryHelper.currentItemId()).craftRemainder(Items.BUCKET).stacksTo(1));
