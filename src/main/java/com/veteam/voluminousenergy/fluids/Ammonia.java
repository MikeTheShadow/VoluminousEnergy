...
public class Ammonia {
    ...
    public static VEFlowingFluidBlock FlowingAmmoniaBlock() {
        AMMONIA_BLOCK = new VEFlowingFluidBlock(AMMONIA, stdProp.setId(VERegistryHelper.currentBlockId()));
        return AMMONIA_BLOCK;
    }

    public static Item AmmoniaBucket() {
        AMMONIA_BUCKET = new BucketItem(AMMONIA, new Item.Properties().setId(VERegistryHelper.currentItemId()).craftRemainder(Items.BUCKET).stacksTo(1));
