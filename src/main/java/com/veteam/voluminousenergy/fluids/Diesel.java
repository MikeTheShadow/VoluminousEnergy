...
public class Diesel {
    public static final ResourceLocation DIESEL_STILL_TEXTURE = ResourceLocation.fromNamespaceAndPath(VoluminousEnergy.MODID, "block/fluids/diesel_still");
    public static final ResourceLocation DIESEL_FLOWING_TEXTURE = ResourceLocation.fromNamespaceAndPath(VoluminousEnergy.MODID, "block/fluids/diesel_flowing");
