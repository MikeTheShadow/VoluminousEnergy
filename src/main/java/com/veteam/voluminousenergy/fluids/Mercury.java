...
public class Mercury {
    public static final ResourceLocation MERCURY_STILL_TEXTURE = ResourceLocation.fromNamespaceAndPath(VoluminousEnergy.MODID, "block/fluids/mercury_still");
    public static final ResourceLocation MERCURY_FLOWING_TEXTURE = ResourceLocation.fromNamespaceAndPath(VoluminousEnergy.MODID, "block/fluids/mercury_flowing");
    ...
    public static final VEFluidType MERCURY_FLUID_TYPE = new VEFluidType(FluidType.Properties.create()
