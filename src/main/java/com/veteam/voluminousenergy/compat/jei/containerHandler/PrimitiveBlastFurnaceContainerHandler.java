...
public class PrimitiveBlastFurnaceContainerHandler implements IGuiContainerHandler<PrimitiveBlastFurnaceScreen> {
    @Override
    public @NotNull Collection<IGuiClickableArea> getGuiClickableAreas(@NotNull PrimitiveBlastFurnaceScreen containerScreen, double guiMouseX, double guiMouseY) {
        ...
        areas.add(new IGuiClickableArea() {
            ...
            public void onClick(@NotNull IFocusFactory focusFactory, @NotNull IRecipesGui recipesGui) {
                recipesGui.showTypes(Lists.newArrayList(PrimitiveBlastingCategory.RECIPE_TYPE));
            }
        });
