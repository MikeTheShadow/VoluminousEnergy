...
public class FluidElectrolyzerContainerHandler implements IGuiContainerHandler<FluidElectrolyzerScreen> {
    @Override
    public @NotNull Collection<IGuiClickableArea> getGuiClickableAreas(@NotNull FluidElectrolyzerScreen containerScreen, double guiMouseX, double guiMouseY) {
        ...
        areas.add(new IGuiClickableArea() {
            ...
            public void onClick(@NotNull IFocusFactory focusFactory, @NotNull IRecipesGui recipesGui) {
                recipesGui.showTypes(Lists.newArrayList(FluidElectrolyzingCategory.RECIPE_TYPE));
            }
        });
