...
public class FluidMixingCategory implements IRecipeCategory<FluidMixerRecipe> {
    ...
    public FluidMixingCategory(IGuiHelper guiHelper) {
        ...
        icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(VEBlocks.FLUID_MIXER.block().get()));
    ...
    @Override
    public void draw(FluidMixerRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphicsExtractor matrixStack, double mouseX, double mouseY) {
