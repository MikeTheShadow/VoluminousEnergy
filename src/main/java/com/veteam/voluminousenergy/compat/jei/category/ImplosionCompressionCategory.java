...
public class ImplosionCompressionCategory implements IRecipeCategory<ImplosionCompressorRecipe> {
    ...
    public ImplosionCompressionCategory(IGuiHelper guiHelper) {
        ...
        icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(VEBlocks.IMPLOSION_COMPRESSOR.block().get()));
    ...
    @Override
    public void draw(ImplosionCompressorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor matrixStack, double mouseX, double mouseY) {
