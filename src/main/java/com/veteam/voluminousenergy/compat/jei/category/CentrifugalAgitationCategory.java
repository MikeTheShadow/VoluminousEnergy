...
public class CentrifugalAgitationCategory implements IRecipeCategory<CentrifugalAgitatorRecipe> {
    ...
    public CentrifugalAgitationCategory(IGuiHelper guiHelper) {
        ...
        icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(VEBlocks.CENTRIFUGAL_AGITATOR.block().get()));
    ...
    @Override
    public void draw(CentrifugalAgitatorRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor matrixStack, double mouseX, double mouseY) {
