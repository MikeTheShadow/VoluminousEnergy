...
public class DistillingCategory implements IRecipeCategory<DistillationRecipe> {
    ...
    public DistillingCategory(IGuiHelper guiHelper) {
        ...
        icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(VEBlocks.DISTILLATION_UNIT.block().get()));
    ...
    @Override
    public void draw(DistillationRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphicsExtractor matrixStack, double mouseX, double mouseY) {
