...
public class FluidElectrolyzingCategory implements IRecipeCategory<FluidElectrolyzerRecipe> {
    ...
    public FluidElectrolyzingCategory(IGuiHelper guiHelper) {
        ...
        icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(VEBlocks.FLUID_ELECTROLYZER.block().get()));
    ...
    @Override
    public void draw(FluidElectrolyzerRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphicsExtractor matrixStack, double mouseX, double mouseY) {
