...
public class CentrifugalSeparatorContainerHandler implements IGuiContainerHandler<CentrifugalSeparatorScreen> {
    @Override
    public @NotNull Collection<IGuiClickableArea> getGuiClickableAreas(@NotNull CentrifugalSeparatorScreen containerScreen, double guiMouseX, double guiMouseY) {
        ...
        areas.add(new IGuiClickableArea() {
            ...
            public void onClick(@NotNull IFocusFactory focusFactory, @NotNull IRecipesGui recipesGui) {
                recipesGui.showTypes(Lists.newArrayList(CentrifugalSeparationCategory.RECIPE_TYPE));
            }
        });
