...
public class CentrifugalSeparatorRecipe extends VERecipe{
    ...
    public static final IRecipeType<CentrifugalSeparatorRecipe> RECIPE_TYPE = VERecipes.VERecipeTypes.CENTRIFUGAL_SEPARATION;
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<CentrifugalSeparatorRecipe>{
        ...
        public CentrifugalSeparatorRecipe fromJson(ResourceLocation recipeId, JsonObject json){
            ...
            int bucketNeeded = JSONUtils.getAsInt(json.get("result").getAsJsonObject(),"buckets",0);
        ...
        @Nullable
        @Override
        public CentrifugalSeparatorRecipe fromNetwork(ResourceLocation recipeId, PacketBuffer buffer){
            CentrifugalSeparatorRecipe recipe = new CentrifugalSeparatorRecipe(recipeId);
        ...
        @Override
        public void toNetwork(PacketBuffer buffer, CentrifugalSeparatorRecipe recipe){
