...
public class RecipeConstants {
    ...
    public static final RegistryObject<IRecipeSerializer<?>> COMBUSTION_GENERATOR_OXIDIZER_RECIPE = VE_RECIPES.register("stirling", () -> CombustionGeneratorOxidizerRecipe.SERIALIZER);
