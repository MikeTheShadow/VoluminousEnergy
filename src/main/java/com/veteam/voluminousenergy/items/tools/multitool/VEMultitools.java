...
public class VEMultitools {
    ...
    public static Supplier<CombustionMultitool> DIAMOND_TRIMMER_MULTITOOL = VE_MULTITOOL_ITEM_REGISTRY.register("diamond_trimmer_multitool", () -> new CombustionMultitool(VEMultitoolBitData.DIAMOND_TRIMMER_BIT_DATA, "diamond_trimmer_multitool", MULTITOOL_PROPERTIES));
    ...
    public static Supplier<CombustionMultitool> TITANIUM_TRIMMER_MULTITOOL = VE_MULTITOOL_ITEM_REGISTRY.register("titanium_trimmer_multitool", () -> new CombustionMultitool(VEMultitoolBitData.TITANIUM_TRIMMER_BIT_DATA, "titanium_trimmer_multitool", MULTITOOL_PROPERTIES));
    ...
    public static Supplier<CombustionMultitool> NIGHALITE_TRIMMER_MULTITOOL = VE_MULTITOOL_ITEM_REGISTRY.register("nighalite_trimmer_multitool", () -> new CombustionMultitool(VEMultitoolBitData.NIGHALITE_TRIMMER_BIT_DATA, "nighalite_trimmer_multitool", MULTITOOL_PROPERTIES));
    ...
    public static Supplier<CombustionMultitool> EIGHZO_TRIMMER_MULTITOOL = VE_MULTITOOL_ITEM_REGISTRY.register("eighzo_trimmer_multitool", () -> new CombustionMultitool(VEMultitoolBitData.EIGHZO_TRIMMER_BIT_DATA, "eighzo_trimmer_multitool", MULTITOOL_PROPERTIES));
    ...
    public static Supplier<CombustionMultitool> SOLARIUM_TRIMMER_MULTITOOL = VE_MULTITOOL_ITEM_REGISTRY.register("solarium_trimmer_multitool", () -> new CombustionMultitool(VEMultitoolBitData.SOLARIUM_TRIMMER_BIT_DATA, "solarium_trimmer_multitool", MULTITOOL_PROPERTIES));
