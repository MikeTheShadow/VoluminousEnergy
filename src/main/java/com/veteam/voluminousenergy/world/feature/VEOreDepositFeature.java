...
public class VEOreDepositFeature extends Feature<BlockStateConfiguration> {
    // Vanilla
    ...
    /* Do NOT normally use this constructor */
    @Deprecated
    public VEOreDepositFeature(Codec<BlockStateConfiguration> codec) {
        super(codec);
    }
            ...
            for(int l2 = 0; l2 < 16; ++l2) {
                for(int k = 0; k < 8; ++k) {
                    ...
                    if (flag) {
                        ...
                        if (k < 4 && !material.isSolid() && worldIn.getBlockState(pos.offset(k1, k, l2)) != this.rawState) {
                            return false;
                        }
                    }
                }
            ...
            for(int i3 = 0; i3 < 16; ++i3) {
                for(int i4 = 0; i4 < 8; ++i4) {
                    if (aboolean[(l1 * 16 + i3) * 8 + i4]) {
                        worldIn.setBlock(pos.offset(l1, i4, i3), this.rawState, 2);
                    }
                }
            }
        }
            ...
            for(int k3 = 0; k3 < 16; ++k3) {
                for(int k4 = 0; k4 < 8; ++k4) {
                    ...
                    if (flag1 && (k4 < 4 || rand.nextInt(2) != 0) && worldIn.getBlockState(pos.offset(j2, k4, k3)).getMaterial().isSolid()) {
                        worldIn.setBlock(pos.offset(j2, k4, k3), this.oreState, 2);
                    }
                }
            }
        }
