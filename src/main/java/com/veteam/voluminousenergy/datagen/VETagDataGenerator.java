...
public class VETagDataGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        final TagKey<Block> NEEDS_NIGHALITE_TOOL = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "needs_nighalite_tool"));
        final TagKey<Block> NEEDS_EIGHZO_TOOL = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "needs_eighzo_tool"));
        final TagKey<Block> NEEDS_SOLARIUM_TOOL = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "needs_solarium_tool"));

        // Setup Incorrect tags
        final TagKey<Block> INCORRECT_FOR_WOOD = TagKey.create(Registries.BLOCK, Identifier.withDefaultNamespace("incorrect_for_wood_tool"));
        final TagKey<Block> INCORRECT_FOR_GOLD = TagKey.create(Registries.BLOCK, Identifier.withDefaultNamespace("incorrect_for_gold_tool"));
        final TagKey<Block> INCORRECT_FOR_STONE = TagKey.create(Registries.BLOCK, Identifier.withDefaultNamespace("incorrect_for_stone_tool"));
        final TagKey<Block> INCORRECT_FOR_IRON = TagKey.create(Registries.BLOCK, Identifier.withDefaultNamespace("incorrect_for_iron_tool"));
        final TagKey<Block> INCORRECT_FOR_DIAMOND = TagKey.create(Registries.BLOCK, Identifier.withDefaultNamespace("incorrect_for_diamond_tool"));
        final TagKey<Block> INCORRECT_FOR_TITANIUM = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "incorrect_for_titanium_tool"));
        final TagKey<Block> INCORRECT_FOR_TUNGSTEN = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "incorrect_for_tungsten_tool"));
        final TagKey<Block> INCORRECT_FOR_NETHERITE = TagKey.create(Registries.BLOCK, Identifier.withDefaultNamespace("incorrect_for_netherite_tool"));
        final TagKey<Block> INCORRECT_FOR_TUNGSTENSTEEL = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "incorrect_for_tungstensteel_tool"));
        final TagKey<Block> INCORRECT_FOR_NIGHALITE = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "incorrect_for_nighalite_tool"));
        final TagKey<Block> INCORRECT_FOR_EIGHZO = TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(VoluminousEnergy.MODID, "incorrect_for_eighzo_tool"));
